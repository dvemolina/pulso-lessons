...
<div class="flex h-full flex-col items-center gap-5">
	...
	<div class="MIDDLEWRAP flex flex-col items-center justify-center gap-4 sm:flex-row md:flex-col">
		<div class="DETAILS flex flex-col justify-center gap-1">
			<div class="flex flex-row items-center gap-2 rounded-md border border-border">
				...
				<h2 class="pr-2 text-textNeutral">{mappedSports}</h2>
			</div>
			<div class="flex flex-row items-center gap-2 rounded-md border border-border">
				<div class="border-r border-border bg-neutral-400/5 p-1">
			...
			<div class="flex flex-row items-center gap-2 rounded-md border border-border">
				...
				<h2 class="pr-2 text-textNeutral">{mappedResort}</h2>
			</div>
		...
		<div class="PRICE flex flex-col items-center justify-center">
