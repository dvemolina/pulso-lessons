...
export const lessonBasicsSchema = z.object({
    ...
    maxSkillId: z.number().optional(),
    minAgeGroupId: z.number().min(1, 'Selecciona Edad del Alumno Mínima'),
    maxAgeGroupId: z.number().optional(),
    pricingMultiplierId: z.number().min(1, 'Selecciona Multiplicador del Precio'),
