...
<form action="" method="post" class="flex flex-col gap-8">
	...
	<div class="flex flex-col">
		<p class="mb-5 self-center text-center font-fira text-xl font-semibold text-text">Rellena Tus Datos. <br> <span class="font-normal underline text-lg">Prepara tu titulación en PDF,<br> te la pediremos al final.</span></p>
		<div class="flex flex-col gap-2 sm:gap-6">
			...
			<div class="flex w-full flex-col gap-2 sm:flex-row">
				<div class="form-unit">
					...
					<p class="field-error w-full">{$errors.country_code}</p>
				</div>
				<div class="form-unit">
					<input
						type="number"
