	...
	<form action="?/signup" method="post" class="flex flex-col gap-8" use:signupEnhance>
		...
		<fieldset class="flex w-full flex-col gap-4">
			<div class="flex flex-col gap-1">
				...
				<p class="mb-5 font-fira text-md text-textNeutral font-normal">Genera los bloques mínimos/máximo de reserva. Cantidad de horas/días que se puede reservar tu lección. </p>
			</div>
			<div class="formgroup">
