...
<div class="flex flex-col md:flex-row justify-evenly items-center mt-24 md:mt-0 w-full h-full px-4">
	<div class="headings flex flex-col justify-center items-center md:items-start  gap-6 text-center md:text-left">
		<h1 class="font-fira text-[1.95rem] font-black uppercase sm:text-4xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-7xl text-text">
			Encuentra a Los Mejores <br /><span
				class="font-sans text-4xl text-primary sm:text-5xl  md:text-[2.5rem] lg:text-5xl xl:text-6xl 2xl:text-8xl"
				>Instructores</span
			> <br />de Tu Montaña
		</h1>
		<h2 class="text-lg font-sans font-medium text-textNeutral  md:text-md lg:text-lg xl:text-2xl 2xl:text-4xl">
			Conecta con Profesionales Locales.<br /> Reserva tus clases de Esquí y Snowboard<br/> en cualquier
			estación de España
		</h2>
    
		<div class="flex flex-col-reverse lg:flex-row gap-4 items-center md:items-end lg:items-center mt-2 ">
    ...
    <div class="cards flex flex-row items-center justify-center max-w-[400px] sm:max-w-[450px] md:max-w-[575px]">
